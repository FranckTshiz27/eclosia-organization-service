...
public class EnrollmentController {
    ...
    @PostMapping
    public ResponseEntity<Enrollment> create(@Valid @RequestBody CreateEnrollmentDto dto) {
        Enrollment enrollment = service.create(dto);
    ...
    public List<Enrollment> findAll(
        ...
        return service.findAll(academicYearId, classroomId, guardianId, studentId);
    }
